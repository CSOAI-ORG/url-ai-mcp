<!-- mcp-name: io.github.CSOAI-ORG/url-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/url-ai-mcp.html)
...
[![PyPI](https://img.shields.io/pypi/v/url-ai-mcp)](https://pypi.org/project/url-ai-mcp/) [![Python](https://img.shields.io/pypi/pyversions/url-ai-mcp)](https://pypi.org/project/url-ai-mcp/)
...
Or: `pip install url-ai-mcp` then run the `url-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `parse_url` to …"
- "Use `shorten_url_data` to …"
- "Use `check_url_safety` to …"
